const CACHE='shici-v5.1.0';
const ASSETS=['./','./index.html','./styles.css','./memory.css','./app.js','./vocabulary-manager.js','./learning-pool.js','./review-manager.js','./stats.js','./vocabulary.html','./sentence.html','./sentence.js','./reading.html','./reading.js','./manifest.webmanifest','./icons/icon.svg','./data/gaokao.json','./data/kaoyan.json','./data/SOURCE.md'];
