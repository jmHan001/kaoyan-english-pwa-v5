...
import{getPool,remove,replace,toggleLock,add,fill,resize,extend}from'./learning-pool.js?v=5.8.1';
...
import{getSyncConfig,isConfigured,startAutoSync}from'./cloud-sync.js?v=5.8.1';
