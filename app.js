...
function startLearnedReview(){const words=learnedWords();$('#learnedModal').classList.add('hidden');if(!words.length){$('#reviewNotice').textContent='还没有已背单词。先完成今日学习池。';$('#reviewNotice').classList.remove('hidden');return}location.href='study.html?mode=learned'}
